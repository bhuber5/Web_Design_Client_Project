...
var formatGoogleCalendar = (function() {
    ...
    var transformationList = function(result, tagName, format) {
        ...
        //CHANGE how date, summary, description, location is outputted in html
        var dateFormatted = getFormattedDate(dateStart, dateEnd, moreDaysEvent, isAllDayEvent, dayNames),
            output = '<' + tagName + '>' + "<img class = 'gameControllerImage' src='images/gameController.png' alt = 'Game Controller' width = '100'/>",
        ...
        for (i = 0; i < format.length; i++) {
            ...
            if (format[i] === '*summary*') {
                output = output.concat('<div class="summary">' + summary + '</div>');
                ...
                output = output.concat('<div class="location">' + location + '</div>');
            } else {
    ...
    var formatDateSameDay = function(dateStart, dateEnd, moreDaysEvent, isAllDayEvent, dayNames) {
        ...
        if (config.sameDayTimes && !moreDaysEvent && !isAllDayEvent) {
            formattedTime = '<br />' + getFormattedTime(dateStart) + ' - ' + getFormattedTime(dateEnd); //CHANGE how datetime is presented
        }
        //CHANGE format to day, month time-time
        //Originally was: month day, year time-time
